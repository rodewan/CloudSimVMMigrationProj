...
public class Helper {
	...
	public static List<Vm> createVmList(int brokerId, int vmsNumber) {
		...
		//this algorithm ends up dividing the vms number by type evenly, e.g. with 20 vms, 5 of type 0, 5 of type 1, 5 of type 2, and 5 of type 3
		for (int i = 0; i < vmsNumber; i++) {
			...
			vms.add(new PowerVm(
					...
					Constants.VM_BW[vmType],  //line edited to reflect different bandwidth allocation per different instances
					Constants.VM_SIZE,
					1,
					"Xen",
